...
R- you are an SQL expert
c- you need to solve a derived field query
T- solve the query and provide a single line explaning of that code
C- do not use very complex code and keep it simple as a beginner can also understand this
F- provide the code and one single line explanation
